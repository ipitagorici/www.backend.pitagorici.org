...
const photosRepository: IPhotosRepository = new FlickrPhotosRepository(env.FLICKR_API_KEY, env.FLICKR_USER_ID);
...
app.use(BASE_URL, OpenRouter(defaultController))
